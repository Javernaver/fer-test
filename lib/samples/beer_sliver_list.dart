...
import 'package:fer_test/remote/beer_summary.dart';
import 'package:fer_test/remote/remote_api.dart';
import 'package:fer_test/samples/common/beer_list_item.dart';
import 'package:fer_test/samples/common/beer_search_input_sliver.dart';
        ...
        slivers: <Widget>[
          ...
          PagedSliverList<int, BeerSummary>(
            ...
            builderDelegate: PagedChildBuilderDelegate<BeerSummary>(
              ...
              itemBuilder: (context, item, index) => FadeInUp(
                child: BeerListItem(
                  beer: item,
                ),
              ),
